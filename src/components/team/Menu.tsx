...
export function TeamMenu(props: Props): JSX.Element {
  ...
  return (
    ...
    >
      <Paper>
        <ListItemButton disabled={true} onClick={() => setSelectedPage('donations')}>
          <DonationIcon />
      ...
      <Paper>
        <ListItemButton onClick={() => setSelectedPage('members')}>
          <UserGroupIcon />
          <CardHeader title="Members" subheader="Invite, manage, and remove team members" />
        </ListItemButton>
      </Paper>
      ...
      <Paper>
        <ListItemButton onClick={() => setSelectedPage('profile')}>
          <ProfileIcon />
          <CardHeader title="Profile" subheader="Manage your team's public image and presence" />
        </ListItemButton>
      </Paper>
      ...
      <Paper>
        <ListItemButton onClick={() => setSelectedPage('projects')}>
          <PuzzleIcon />
          <CardHeader title="Projects" subheader="Create and manage Mods and other projects" />
        </ListItemButton>
      </Paper>

      <Paper>
        <ListItemButton disabled={true} onClick={() => setSelectedPage('reputation')}>
          <ShieldIcon />
          <CardHeader
            title="Reputation"
      ...
      <Paper>
        <ListItemButton onClick={() => setSelectedPage('profile')}>
          <SettingsIcon />
          <CardHeader title="Settings" subheader="Manage your team's privacy and settings" />
        </ListItemButton>
      </Paper>
    </Box>
  )
