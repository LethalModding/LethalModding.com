...
export function ModListItem(props: Props): JSX.Element {
  ...
  return (
    <ListItemButton>
      ...
      <IconButton color="primary" onClick={(e) => setMenuAnchor(e.currentTarget)}>
        <DotsIcon color="inherit" />
      </IconButton>

      <Menu anchorEl={menuAnchor} onClose={() => setMenuAnchor(null)} open={menuOpen}>
        <MenuItem>
          <WorldIcon color="inherit" fontSize="inherit" sx={{ mr: 1 }} />
          <Typography variant="body2">Website</Typography>
        </MenuItem>
        <Divider />
        <MenuItem>
          <SettingsIcon color="inherit" fontSize="inherit" sx={{ mr: 1 }} />
