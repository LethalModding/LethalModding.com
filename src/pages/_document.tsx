    ...
    return (
      <Html lang="en">
        <Head>
          ...
          <meta name="msapplication-TileColor" content={darkThemeOptions.palette.primary.main} />
...
MyDocument.getInitialProps = async (ctx: DocumentContext) => {
  ...
  ctx.renderPage = () =>
    originalRenderPage({
      // Next's Enhancer type has no slot for the extra prop the emotion cache
      // is threaded through, so the app component is re-typed here.
